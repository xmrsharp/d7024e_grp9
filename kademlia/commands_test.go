...
func TestCommandGet(t *testing.T) {
	assert.Equal(t, "Arg error", comSend("get")) //skicka fel antal inputs, som ska returna "Arg error"
}

func TestCommandPut(t *testing.T) {
	assert.Equal(t, "Arg error", comSend("put")) //skicka fel antal inputs, som ska returna "Arg error"
}
...
func TestWrongCommand(t *testing.T) {
	assert.Equal(t, "invalid command", comSend("test"))
}
